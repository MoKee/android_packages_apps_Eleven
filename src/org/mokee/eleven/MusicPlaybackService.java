...
import org.mokee.eleven.Config.IdType;
import org.mokee.eleven.appwidgets.AppWidgetLarge;
import org.mokee.eleven.appwidgets.AppWidgetLargeAlternate;
import org.mokee.eleven.appwidgets.AppWidgetSmall;
import org.mokee.eleven.cache.ImageCache;
import org.mokee.eleven.cache.ImageFetcher;
import org.mokee.eleven.provider.MusicPlaybackState;
import org.mokee.eleven.provider.RecentStore;
import org.mokee.eleven.provider.SongPlayCount;
import org.mokee.eleven.service.MusicPlaybackTrack;
import org.mokee.eleven.utils.BitmapWithColors;
import org.mokee.eleven.utils.Lists;
import org.mokee.eleven.utils.PreferenceUtils;
import org.mokee.eleven.utils.ShakeDetector;
import org.mokee.eleven.utils.SrtManager;
...
public class MusicPlaybackService extends Service {
     ...
     */
    public static final String PLAYSTATE_CHANGED = "org.mokee.eleven.playstatechanged";

    /**
     * Indicates that music playback position within
     * a title was changed
     */
    public static final String POSITION_CHANGED = "org.mokee.eleven.positionchanged";

    /**
     * Indicates the meta data has changed in some way, like a track change
     */
    public static final String META_CHANGED = "org.mokee.eleven.metachanged";

    /**
     * Indicates the queue has been updated
     */
    public static final String QUEUE_CHANGED = "org.mokee.eleven.queuechanged";

    /**
     * Indicates the queue has been updated
     */
    public static final String PLAYLIST_CHANGED = "org.mokee.eleven.playlistchanged";

    /**
     * Indicates the repeat mode changed
     */
    public static final String REPEATMODE_CHANGED = "org.mokee.eleven.repeatmodechanged";

    /**
     * Indicates the shuffle mode changed
     */
    public static final String SHUFFLEMODE_CHANGED = "org.mokee.eleven.shufflemodechanged";

    /**
     * Indicates the track fails to play
     */
    public static final String TRACK_ERROR = "org.mokee.eleven.trackerror";

    /**
     * For backwards compatibility reasons, also provide sticky
     * broadcasts under the music package
     */
    public static final String ELEVEN_PACKAGE_NAME = "org.mokee.eleven";
     ...
     */
    public static final String SERVICECMD = "org.mokee.eleven.musicservicecommand";

    /**
     * Called to go toggle between pausing and playing the music
     */
    public static final String TOGGLEPAUSE_ACTION = "org.mokee.eleven.togglepause";

    /**
     * Called to go to pause the playback
     */
    public static final String PAUSE_ACTION = "org.mokee.eleven.pause";

    /**
     * Called to go to stop the playback
     */
    public static final String STOP_ACTION = "org.mokee.eleven.stop";

    /**
     * Called to go to stop the playback for sleep mode
     */
    public static final String SLEEP_MODE_STOP_ACTION = "org.mokee.eleven.sleepmode.stop";

    /**
     * Called to go to the previous track or the beginning of the track if partway through the track
     */
    public static final String PREVIOUS_ACTION = "org.mokee.eleven.previous";

    /**
     * Called to go to the previous track regardless of how far in the current track the playback is
     */
    public static final String PREVIOUS_FORCE_ACTION = "org.mokee.eleven.previous.force";

    /**
     * Called to go to the next track
     */
    public static final String NEXT_ACTION = "org.mokee.eleven.next";

    /**
     * Called to change the repeat mode
     */
    public static final String REPEAT_ACTION = "org.mokee.eleven.repeat";

    /**
     * Called to change the shuffle mode
     */
    public static final String SHUFFLE_ACTION = "org.mokee.eleven.shuffle";
     ...
     * changes
     */
    public static final String REFRESH = "org.mokee.eleven.refresh";

    /**
     * Used by the alarm intent to shutdown the service after being idle
     */
    private static final String SHUTDOWN = "org.mokee.eleven.shutdown";

    /**
     * Called to notify of a timed text
     */
    public static final String NEW_LYRICS = "org.mokee.eleven.lyrics";

    /**
     * Called to update the remote control client
     */
    public static final String UPDATE_LOCKSCREEN = "org.mokee.eleven.updatelockscreen";
    ...
    private Notification buildNotification() {
        ...
        Intent nowPlayingIntent = new Intent("org.mokee.eleven.AUDIO_PLAYER")
